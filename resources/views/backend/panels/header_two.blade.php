            ...
            <li class="nav-item">
                <a class="navbar-brand" href="{{--{{ route('admin.index') }}--}}">
                     <span class="brand-logo">
                        <img src="{{ asset('assets/img/logo-oscn.png') }}">
                    </span>
                </a>
            </li>
        </ul>
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="avatar">
                        <img class="round" src="{{ asset('backend_assets/images/avatars/circled-user-80.png') }}" alt="avatar" height="40" width="40">
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion">
        <a class="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
            <div class="d-flex">
                <div class="mr-75">
                    <img src="../../../app-assets/images/icons/jpg.png" alt="png" height="32"></div>
                <div class="search-data">
