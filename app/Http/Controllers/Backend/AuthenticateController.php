    ...
    public function logout(Request $request): RedirectResponse
    {
     ...
     public function index_chefequipe(Request $request){
        ...
        if ($request->ajax()) {
            ...
            return view('backend.page.utilisateur.chefequipe', compact('utilisateurs','totalutilisateur'));
        }

        return view('backend.page.utilisateur.index_chefequipe', compact('utilisateurs','totalutilisateur'));
     ...
     public function index_superviseur(Request $request){
        ...
        if ($request->ajax()) {
            ...
            return view('backend.page.utilisateur.superviseur', compact('utilisateurs','totalutilisateur'));
        }

        return view('backend.page.utilisateur.index_superviseur', compact('utilisateurs','totalutilisateur'));
