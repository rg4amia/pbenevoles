                            ...
                            <div id="wizard_container">
                                        ...
                                        <div class="row add_bottom_30">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="styled-select">
                                                        <select class="required" name="situationmatrimoniale">
                                                            <option value="" selected>Situation professionnelle
                                                                actuelle
                                                            </option>
                                                ...
                                                <div class="form-group">
                                                    <div class="styled-select">
                                                        <select class="required" name="situationmatrimoniale">
                                                            <option value="" selected>Êtes-vous membre d'une
                                                                association?
                                                            </option>
                                ...
                                <form id="structure" method="POST" style="display: none;">
                                    ...
                                    <div id="middle-wizard">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input type="text" name="prenom_repondant" class="required form-control"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="prenom_repondant" class="required form-control"
                                                       placeholder=" Désirez-vous nous communiquer d’autres informations ? Si oui, les quelles ?">
                                            </div>
                                        </div><!-- /col-sm-6 -->
