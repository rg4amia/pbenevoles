            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">UTILISATEURS</h2>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-xl-12 col-lg-12">
                                    <div class="card">
                                        ...
                                        <div id="benevoles">
                                            @include('backend.page.utilisateur.utilisateur')
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            $('#tableBenevole').DataTable({
              ...
              //  serverSide: false,
                ...
                buttons: [
                    ...
                    {
                        extend: 'colvis',
                        text: feather.icons['plus'].toSvg({class: 'font-small-4 mr-50'}) + 'Nouvel utilisateur',
                        className: 'btn btn-relief-info',
                        action: function (e, dt, node, config) {
                            var link = "{{ route('utilisateur.nouveau') }}";
                            location.href = link
                        }
                    },
                    {
